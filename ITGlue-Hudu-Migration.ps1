...
############################### Wrap-Up ###############################
write-host "wrapup 1/11... setting asset layouts as active, enabling advanced website monitoring features" -ForegroundColor DarkCyan
...
write-host "wrapup 2/11... adding attachments (this can take a while)"
. .\Add-HuduAttachmentsViaAPI.ps1

write-host "wrapup 3/11... Creating IPAM/Networks and Addresses if user-configured to do so... $($importChecklists)"
...
write-host "wrapup 4/11... archiving passwords, assets, configurations as they had been in ITGlue (this can take a while)"  -ForegroundColor DarkCyan
...
write-host "wrapup 5/11... archiving items..."  -ForegroundColor DarkCyan
...
write-host "wrapup 6/11... Setting Standalone articles with attachments to filename..."
...
write-host "wrapup 7/11... Placing password folders if user-configured to do so... $($importPasswordFolders)"
if ($true -eq $importPasswordFolders){
    . .\public\Process-PasswordFolders.ps1
}
write-host "wrapup 8/11... Placing checklists / checklist templates if user-configured to do so... $($importChecklists)"
...
write-host "wrapup 9/11... adding missing relations (this can take a long while). Some errors may appear but can be safely ignored."  -ForegroundColor DarkCyan
...
write-host "wrapup 10/11... $(if ($true -eq $allowSettingFlagsAndTypes) {"Setting"} else {"Skipping"}) optional flags and flag types..."
